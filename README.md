...
| Проект        | Тэги                                                             | Описание                 |
| ------------- | ---------------------------------------------------------------- | ------------------------ | 
| [Автоматизированная выгрузка информации из банковских бюллетеней ЦБ РФ](https://github.com/Denis1gn/portfolio/tree/main/CBR_parsing) | `BeautifulSoup`, `PyPDF2`, `tabula`  | Проект по загрузке данных из PDF файлов ститистических бюллетеней ЦБ РФ. |
