...
|[Модель сопоставления товаров]([https://github.com/Denis1gn/portfolio/tree/main/Price%20regression](https://github.com/Denis1gn/portfolio/tree/main/Matching) | `Сопоставление`, `FAISS`, `HNSW`| Модель сопоставляющая товары под метрику accuracy@5|
