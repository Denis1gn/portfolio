<div id="header" align="center">
    ...
    <h3>Инвестиционный аналитик | DS/ML специалист</h3>
</div>
...
- Инженер машинного обучения от Yandex Practicum 
...
| Проект        | Тэги                                                             | Описание                 |
| ------------- | ---------------------------------------------------------------- | ------------------------ | 
| [Анализ и оптимизация инвестиционного портфеля MOEX](https://github.com/Denis1gn/portfolio_app) | `Streamlit`, `Docker`, `Scipy`, `Plotly`, `API MOEX` | Интерактивный дашборд с выгрузкой исторических данных MOEX, анализ портфеля и оптимизация риска портфеля. |
...
| [Финансовая модель с тремя формами отчетности](https://github.com/Denis1gn/portfolio/tree/main/Finance/Financial%20model) | `Оценка стоимости компаний`, `Финансовая модель`, `DCF`, `WACC` | Две финансовые модели: эталонная финансовая модель с тремя формами отчетности, финансовая модель с тремя формами и распределением налогов по бюджетам РФ |
