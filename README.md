...
| Проект        |Тэги           |
| ------------- | ------------- | 
| [Финансовая модель с тремя формами отчетности](https://github.com/Denis1gn/portfolio/tree/main/Financial%20model) | '#Оценка компаний' 	`#64b624 #Оценка компаний` `rgb(9, 105, 218)`| 
