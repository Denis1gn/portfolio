...
| [Финансовая модель с тремя формами отчетности](https://github.com/Denis1gn/portfolio/tree/main/Finance/Financial%20model) | `Оценка стоимости компаний`, `Финансовая модель`, `DCF`, `WACC` | Две финансовой модели: эталонная финансовая модель с тремя формами отчетности, финансовая модель с тремя формами и распределением налогов по бюджетам РФ |
