...
| [Событийный анализ на рынке акций](https://github.com/Denis1gn/portfolio/tree/main/Stocks_project) | `API MOEX`, `Акции`, `Прогнозирование`, `Событийный анализ`, `Расчет бета коэффициента`, `Расчет альфа коэффициента`  | Подключение к API Moex & применение событийного анализа |
